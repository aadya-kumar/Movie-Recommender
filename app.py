...
#     distance = sorted(list(enumerate(similarities[index])), reverse=True, key=lambda vector:vector[1])
#     recommend_movs=[]
#     for i in distance[1:6]:
#         recommend_movs.append(movie.iloc[i[0]].title)
#     return recommend_movs

# if st.button("Show recommended movies"):
#     mov_name=recommend(select_value)
